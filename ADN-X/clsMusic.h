...
class clsMusic
{
    ...
    public:
      int load(const char*); // Carga un archivo de musica (tipo mp3).
      void play(int);        // Ejecuta un archivo de musica.
      void pause();
      void resume();
      void stop();           // Detiene la musica.
      void close();          // Libera la memoria tomada para la musica.
      int getStatus();
